...
/* harmony import */ var _donation_map_map_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./donation/map/map.component */ "./src/app/donation/map/map.component.ts");
/* harmony import */ var _donation_list_list_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./donation/list/list.component */ "./src/app/donation/list/list.component.ts");
...
/* harmony import */ var _donation_organisation_organisation_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./donation/organisation/organisation.component */ "./src/app/donation/organisation/organisation.component.ts");
/* harmony import */ var _imprint_imprint_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./imprint/imprint.component */ "./src/app/imprint/imprint.component.ts");
...
const routes = [
    ...
    { path: 'overview', component: _overview_overview_component__WEBPACK_IMPORTED_MODULE_11__["OverviewComponent"] },
    { path: 'donation/map', component: _donation_map_map_component__WEBPACK_IMPORTED_MODULE_12__["MapComponent"] },
    { path: 'donation/list', component: _donation_list_list_component__WEBPACK_IMPORTED_MODULE_13__["ListComponent"] },
    { path: 'donation/organisation', component: _donation_organisation_organisation_component__WEBPACK_IMPORTED_MODULE_17__["OrganisationComponent"] },
    // children: [
    //   {path: 'map', component: MapComponent},
    //   {path: 'list', component: ListComponent},
    //   {path: 'organisation', component: FundComponent},
    // ]
    { path: 'imprint', component: _imprint_imprint_component__WEBPACK_IMPORTED_MODULE_18__["ImprintComponent"] },
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _donation_map_map_component__WEBPACK_IMPORTED_MODULE_12__["MapComponent"],
            _donation_organisation_organisation_component__WEBPACK_IMPORTED_MODULE_17__["OrganisationComponent"],
            _donation_list_list_component__WEBPACK_IMPORTED_MODULE_13__["ListComponent"],
            ...
            _imprint_imprint_component__WEBPACK_IMPORTED_MODULE_18__["ImprintComponent"],
        ],
        imports: [
            _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouterModule"].forRoot(routes, { enableTracing: false }),
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _service_toast_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../service/toast.service */ "./src/app/service/toast.service.ts");
...
let ListComponent = class ListComponent {
    constructor(route, router, httpService, orderService, toastService) {
        this.route = route;
        this.router = router;
    ...
    getAndSetCountries() {
        this.httpService.getCountries().subscribe((data) => this.countries = data);
    }
    onSelectDonation() {
...
ListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-list',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./list.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/donation/list/list.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./list.component.css */ "./src/app/donation/list/list.component.css")).default]
    })
], ListComponent);
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _service_toast_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../service/toast.service */ "./src/app/service/toast.service.ts");
/* harmony import */ var ngx_page_scroll_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-page-scroll-core */ "./node_modules/ngx-page-scroll-core/fesm2015/ngx-page-scroll-core.js");
...
let MapComponent = class MapComponent {
    constructor(route, router, httpService, orderService, toastService, pageScrollService) {
        this.route = route;
        this.router = router;
        this.httpService = httpService;
        this.orderService = orderService;
    ...
    getAndSetCountries() {
        return this.httpService.getCountries().subscribe((data) => this.countries = data);
    }
    onSelectDonation() {
        this.orderService.removeOrder(this.currentOrder);
        this.toastService.display();
...
MapComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-map',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./map.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/donation/map/map.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./map.component.css */ "./src/app/donation/map/map.component.css")).default]
    })
], MapComponent);
...
let OrganisationComponent = class OrganisationComponent {
    constructor(route, router, orderService, httpService, toastService) {
        this.route = route;
        this.router = router;
        this.orderService = orderService;
        this.httpService = httpService;
    ...
    getAndSetOrganisations() {
        this.httpService.getOrganisations().subscribe((data) => this.organisations = data);
    }
    onSelectDonation() {
        this.orderService.removeOrder(this.currentOrder);
        this.toastService.display();
...
OrganisationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./organisation.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/donation/organisation/organisation.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./organisation.component.css */ "./src/app/donation/organisation/organisation.component.css")).default]
    })
...
let HomeComponent = class HomeComponent {
    constructor(formBuilder, orderService, router) {
    ...
    onSubmitRedeemedOrder(customerData) {
...
let ImprintComponent = class ImprintComponent {
    constructor() { }
    ngOnInit() {
    }
};
ImprintComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./imprint.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/imprint/imprint.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./imprint.component.css */ "./src/app/imprint/imprint.component.css")).default]
    })
], ImprintComponent);
...
const timeoutTillRedirection = 3000;
...
/* harmony import */ var _uuid_generator_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./uuid-generator.service */ "./src/app/service/uuid-generator.service.ts");
...
let OrderService = class OrderService {
    ...
    // }
    constructor(uuidGeneratorService, storageService) {
    ...
    setIsRandomOrders(isRandomOrders) {
    ...
    loadCurrentOrderFromLocalStorage() {
...
OrderService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](1, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(ngx_webstorage_service__WEBPACK_IMPORTED_MODULE_2__["SESSION_STORAGE"]))
], OrderService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UuidGeneratorService", function() { return UuidGeneratorService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let UuidGeneratorService = class UuidGeneratorService {
    constructor() {
...
UuidGeneratorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
module.exports = __webpack_require__(/*! C:\Users\DANGL\OneDrive\Software\Angular\plantshop-rainforest-reafforestation\src\main.ts */"./src/main.ts");
